...
import { useModuleFindFirst, useRoqClient } from 'lib/roq';

import { ModuleInterface } from 'interfaces/module';
import { ProgressListPage } from 'pages/progresses';
...
function ModuleViewPage() {
  ...
  const queryParams = useMemo<{ include: { content: boolean } }>(
    () =>
  ...
  const { data, error, isLoading } = useModuleFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('module', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/modules/edit/${id}`} passHref legacyBehavior>
                    <Button
