  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="AI Tutor - Transforming static educational content into engaging and interactive eLearning modules. Facilitating educators with dynamic content conversion, gamification, animations, and interactive visuals. Enabling creation of diverse eLearning modules and interactive videos. Your ultimate tool for enjoyable, engaging, and efficient learning."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1583232705433-c2fee07be069?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxlTGVhcm5pbmd8ZW58MHx8fHwxNjk5NDM3MjQ2fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@webfactoryltd?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`WebFactory Ltd`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`AI Tutor - Transforming static educational content into engaging and interactive eLearning modules. Facilitating educators with dynamic content conversion, gamification, animations, and interactive visuals. Enabling creation of diverse eLearning modules and interactive videos. Your ultimate tool for enjoyable, engaging, and efficient learning.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                ...
                <Card userTypeName="Learner" type="learner" abilities={appConfig.customerAbilities} />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
