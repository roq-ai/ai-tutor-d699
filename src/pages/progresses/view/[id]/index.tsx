...
import { useProgressFindFirst, useRoqClient } from 'lib/roq';
...
function ProgressViewPage() {
  ...
  const queryParams = useMemo<{ include: { user: boolean; module: boolean } }>(
    () =>
  ...
  const { data, error, isLoading } = useProgressFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('progress', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/progresses/edit/${id}`} passHref legacyBehavior>
                    <Button
