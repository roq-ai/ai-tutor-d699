...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['administrator', 'content-creator', 'educator', 'content-reviewer'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Modules', path: '/modules', entity: 'module', service: AccessServiceEnum.PROJECT, icon: FiBox },
    {
      name: 'Progresses',
      path: '/progresses',
      entity: 'progress',
    ...
    { name: 'Quizzes', path: '/quizzes', entity: 'quiz', service: AccessServiceEnum.PROJECT, icon: FiHelpCircle },
